...
export const userListData = (params?: User | any) =>
  request.post<Page<User>>({ url: adminPath + '/sys/user/listData', params });
...
export const userInfo = (params?: any) =>
  request.post<User>({ url: adminPath + '/sys/user/info', params });

export const infoSaveBase = (params?: any) =>
  request.post<User>({ url: adminPath + '/sys/user/infoSaveBase', params });
export const infoSavePwd = (params?: any) => {
  params.oldPassword = encryptByRSA(params.oldPassword);
  params.newPassword = encryptByRSA(params.newPassword);
  params.confirmNewPassword = encryptByRSA(params.confirmNewPassword);
  return request.post<User>({ url: adminPath + '/sys/user/infoSavePwd', params });
};

export const infoSavePqa = (params?: any) =>
  request.post<User>({ url: adminPath + '/sys/user/infoSavePqa', params });
