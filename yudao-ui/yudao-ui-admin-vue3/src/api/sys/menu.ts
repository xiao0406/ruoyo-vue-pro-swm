...
export const menuIndex = (params?: Menu | any) =>
  request.get<Menu>({ url: adminPath + '/sys/menu/index', params });

export const menuList = (params?: Menu | any) =>
  request.get<Menu>({ url: adminPath + '/sys/menu/list', params });

export const menuListData = (params?: Menu | any) =>
  request.post<Menu[]>({ url: adminPath + '/sys/menu/listData', params });

export const menuForm = (params?: Menu | any) =>
  request.get<Menu>({ url: adminPath + '/sys/menu/form', params });

export const menuCreateNextNode = (params?: Menu | any) =>
  request.get<Menu>({ url: adminPath + '/sys/menu/createNextNode', params });

export const menuSave = (params?: any, data?: Menu | any) =>
  request.postJson<Menu>({ url: adminPath + '/sys/custom/menu/save', params, data });

export const menuDisable = (params?: Menu | any) =>
  request.get<Menu>({ url: adminPath + '/sys/menu/disable', params });

export const menuEnable = (params?: Menu | any) =>
  request.get<Menu>({ url: adminPath + '/sys/menu/enable', params });

export const menuDelete = (params?: Menu | any) =>
  request.get<Menu>({ url: adminPath + '/sys/menu/delete', params });

export const menuTreeData = (params?: any) =>
  request.get<TreeDataModel[]>({ url: adminPath + '/sys/menu/treeData', params });

export const propertyTreeData = (params?: any) =>
  request.get<TreeDataModel[]>({ url: adminPath + '/sys/layout/treeData', params });
