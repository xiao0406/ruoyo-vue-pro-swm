...
export const logList = (params?: Log | any) =>
  request.get<Log>({ url: adminPath + '/sys/log/list', params });

export const logListData = (params?: Log | any) =>
  request.post<Page<Log>>({ url: adminPath + '/sys/log/listData', params });

export const logForm = (params?: Log | any) =>
  request.get<Log>({ url: adminPath + '/sys/log/form', params });
