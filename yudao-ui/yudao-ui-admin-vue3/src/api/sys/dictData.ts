...
export const dictDataList = (params?: DictData | any) =>
  request.get<DictData>({ url: adminPath + '/sys/dictData/list', params });

export const dictDataListData = (params?: DictData | any) =>
  request.post<DictData[]>({ url: adminPath + '/sys/dictData/listData', params });

export const dictDataForm = (params?: DictData | any) =>
  request.get<DictData>({ url: adminPath + '/sys/dictData/form', params });

export const dictDataCreateNextNode = (params?: DictData | any) =>
  request.get<DictData>({ url: adminPath + '/sys/dictData/createNextNode', params });

export const dictDataSave = (params?: any, data?: DictData | any) =>
  request.postJson<DictData>({ url: adminPath + '/sys/dictData/save', params, data });

export const dictDataDelete = (params?: DictData | any) =>
  request.get<DictData>({ url: adminPath + '/sys/dictData/delete', params });

export const dictDataTreeData = (params?: any) =>
  request.get<DictDataTree[]>({ url: adminPath + '/sys/dictData/treeData', params });
