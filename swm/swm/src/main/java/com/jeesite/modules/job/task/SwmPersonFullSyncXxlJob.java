...
public class SwmPersonFullSyncXxlJob {
    ...
    /**
     * 分批发送MQ消息（复用原有逻辑，适配XXL-Job）
     */
    private void sendFullSyncMq(List<SwmPerson> personList) {
        ...
        for (int i = 0; i < batchNum; i++) {
            ...
            List<SwmPerson> batchPersonList = personList.subList(start, end);
